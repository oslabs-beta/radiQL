              ...
              <div className='app-description'>
                  ...
                  <section className='info-1'>
                      <span>
                          ...
                          <hr />
                          <p>
                              radiQL is a web application for generating GraphQL
                              schemas and resolvers for your database.
                          </p>
                          <p>
                              While GraphQL is great, there is a big learning
                              curve setting up schemas and resolvers.
                              Transitioning from a REST API infrastructure to a
                              GraphQL infrastructure is no easy task.
                          </p>
                      </span>
                      <img src={about1}></img>
                  </section>
                  <section className='info-1'>
                      ...
                      <span>
                          ...
                          <hr />
                          <p>
                              REST APIs are great, but they have some problems
                              that can slow down servers, especially when
                              working with large databases. REST calls have a
                              problem with over-fetching data, which leads to
                              longer response times; as well as under-fetching
                              data, which leads to creating multiple fetch
                              requests to retrieve the desired data.
                          </p>
                          <p>
                              While GraphQL is great, there is a big learning
                              curve setting up schemas and resolvers.
                          ...
                          <p>That's where our app comes in...</p>
                      </span>
                  </section>
              </div>
          </motion.div>
              ...
              <span className='about-box about-1'>
                  ...
                  <section>
                      ...
                      <p>
                          <a
                              className='link'
                              href='https://github.com/Alex-cusick'
                          >
                              <FaGithub />
                          </a>
                          <a
                              className='link'
                              href='https://www.linkedin.com/in/alex-q6/'
                          >
                              <FaLinkedin />
                          </a>
                      </p>
              ...
              <span className='about-box about-2'>
                  ...
                  <section>
                      ...
                      <p>
                          ...
                          <a
                              className='link'
                              href='https://www.linkedin.com/in/t1ho/'
                          >
                              <FaLinkedin />
                          </a>
                      </p>
              ...
              <span className='about-box about-3'>
                  ...
                  <section>
                      ...
                      <p>
                          <a
                              className='link'
                              href='https://github.com/rjiang12'
                          >
                              <FaGithub />
                          </a>
                          <a
                              className='link'
                              href='https://www.linkedin.com/in/royjiang2025/'
                          >
                              <FaLinkedin />
                          </a>
                      </p>
              ...
              <span className='about-box about-4'>
                  ...
                  <section>
                      ...
                      <p>
                          <a
                              className='link'
                              href='https://github.com/Zachrobdev'
                          >
                              <FaGithub />
                          </a>
                          <a
                              className='link'
                              href='https://www.linkedin.com/in/zach-robertson-profile/'
                          >
                              <FaLinkedin />
                          </a>
                      </p>
              ...
              <span className='about-box about-5'>
                  ...
                  <section>
                      ...
                      <p>
                          <a
                              className='link'
                              href='https://github.com/jordanobl'
                          >
                              <FaGithub />
                          </a>
                          <a
